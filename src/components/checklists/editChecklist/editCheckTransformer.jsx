                    ...
                    <div className='flex flex-col gap-4 w-5/6'>
                        <label className='flex w-full justify-between'>
                            ...
                            <div className='w-1/2 flex justify-between'>
                                OFF
                                <input disabled={inputStatus} type="checkbox" {...register("sw_in1")} className="toggle toggle-success max-md:toggle-sm" />
                                ON 
                            </div>
                        </label>
                        <label className='flex w-full justify-between'>
                            ...
                            <div className='w-1/2 flex justify-between'>
                                OFF
                                <input disabled={inputStatus} type="checkbox" {...register("sw_ground_in1")} className="toggle toggle-success max-md:toggle-sm" />
                                ON 
                            </div>
                        </label>
                        <label className='flex w-full justify-between'>
                            ...
                            <div className='w-1/2 flex justify-between'>
                                Abnormal
                                <input disabled={inputStatus} type="checkbox" {...register("lamp_rmu_in1")} className="toggle toggle-success max-md:toggle-sm mx-2" />
                                Normal
                            </div>
                        </label>
                        <label className='flex w-full justify-between'>
                ...
                <div className='flex flex-col items-center gap-5 border py-5 md:w-1/2 rounded'>
                    ...
                    <div className='flex flex-col gap-4 w-5/6'>
                        <label className='flex w-full justify-between'>
                            ...
                            <div className='w-1/2 flex justify-between'>
                                OFF
                                <input disabled={inputStatus} type="checkbox" {...register("sw_in2")} className="toggle toggle-success max-md:toggle-sm" />
                                ON 
                            </div>
                        </label>
                        <label className='flex w-full justify-between'>
                            ...
                            <div className='w-1/2 flex justify-between'>
                                OFF
                                <input disabled={inputStatus} type="checkbox" {...register("sw_ground_in2")} className="toggle toggle-success max-md:toggle-sm" />
                                ON 
                            </div>
                        </label>
                        <label className='flex w-full justify-between'>
                            ...
                            <div className='w-1/2 flex justify-between'>
                                Abnormal
                                <input disabled={inputStatus} type="checkbox" {...register("lamp_rmu_in2")} className="toggle toggle-success max-md:toggle-sm mx-2" />
                                Normal
                            </div>
                        </label>
                        <label className='flex w-full justify-between'>
                ...
                <div className='flex flex-col items-center gap-5 border py-5 md:w-1/2 rounded'>
                    ...
                    <div className='flex flex-col gap-4 w-5/6'>
                        <label className='flex w-full justify-between'>
                            ...
                            <div className='w-1/2 flex justify-between'>
                                OFF
                                <input disabled={inputStatus} type="checkbox" {...register("sw1_out1")} className="toggle toggle-success max-md:toggle-sm" />
                                ON 
                            </div>
                        </label>
                        <label className='flex w-full justify-between'>
                            ...
                            <div className='w-1/2 flex justify-between'>
                                OFF
                                <input disabled={inputStatus} type="checkbox" {...register("sw2_out1")} className="toggle toggle-success max-md:toggle-sm" />
                                ON 
                            </div>
                        </label>
                        <label className='flex w-full justify-between'>
                            ...
                            <div className='w-1/2 flex justify-between'>
                                OFF
                                <input disabled={inputStatus} type="checkbox" {...register("sw_ground_out1")} className="toggle toggle-success max-md:toggle-sm" />
                                ON 
                            </div>
                        </label>
                        <label className='flex w-full justify-between'>
                            ...
                            <div className='w-1/2 flex justify-between'>
                                Abnormal
                                <input disabled={inputStatus} type="checkbox" {...register("lamp_rmu_out1")} className="toggle toggle-success max-md:toggle-sm mx-2" />
                                Normal
                            </div>
                        </label>
                        <label className='flex w-full justify-between'>
                ...
                <div className='flex flex-col items-center gap-5 border py-5 md:w-1/2 rounded'>
                    ...
                    <div className='flex flex-col gap-4 w-5/6'>
                        <label className='flex w-full justify-between'>
                            ...
                            <div className='w-1/2 flex justify-between'>
                                OFF
                                <input disabled={inputStatus} type="checkbox" {...register("sw1_out2")} className="toggle toggle-success max-md:toggle-sm" />
                                ON 
                            </div>
                        </label>
                        <label className='flex w-full justify-between'>
                            ...
                            <div className='w-1/2 flex justify-between'>
                                OFF
                                <input disabled={inputStatus} type="checkbox" {...register("sw2_out2")} className="toggle toggle-success max-md:toggle-sm" />
                                ON 
                            </div>
                        </label>                        
                        <label className='flex w-full justify-between'>
                            ...
                            <div className='w-1/2 flex justify-between'>
                                OFF
                                <input disabled={inputStatus} type="checkbox" {...register("sw_ground_out2")} className="toggle toggle-success max-md:toggle-sm" />
                                ON 
                            </div>
                        </label>
                        <label className='flex w-full justify-between'>
                            ...
                            <div className='w-1/2 flex justify-between'>
                                Abnormal
                                <input disabled={inputStatus} type="checkbox" {...register("lamp_rmu_out2")} className="toggle toggle-success max-md:toggle-sm mx-2" />
                                Normal
                            </div>
                        </label>
                        <label className='flex w-full justify-between'>
            ...
            <div>
                <label className='flex md:w-1/3 justify-between border p-4 rounded'>
                    ...
                    <div className='w-1/2 flex justify-between'>
                        ...
                        <input disabled={inputStatus} type="checkbox" {...register("pressure")} className="toggle toggle-success max-md:toggle-sm" />
            ...
            <div className='flex w-full flex-col border rounded py-2 items-center'>
                ...
                <div className='grid grid-cols-3 max-md:grid-cols-1 px-2 gap-2'>
                        ...
                        <div className='flex flex-col gap-3'>
                            <label className='flex w-full flex-col gap-2'>
                                ...
                                <div className='flex justify-between'>
                                    Manual mode
                                    <input disabled={inputStatus} type="checkbox" {...register("mode_fan")} className="toggle toggle-success max-md:toggle-sm mx-2" />
                                    Auto mode
                                </div>
                            </label>
                        </div>
                    ...
                    <label className='flex flex-col items-center gap-5 border p-5 rounded'>
                        <div className='flex justify-between w-full'>
                            Meter TOU
                            <input disabled={inputStatus} {...register("meter_TOU", { required: {value: true , message : "Meter TOU is required"}})} className='bg-gray-50 px-2' placeholder='kwh'/>
                        </div>
                        {errors["meter_TOU"] && <span className="text-red-500">{errors["meter_TOU"]?.message}</span>}
                        <div className='flex justify-between w-full'>
                            On Peak
                            <input disabled={inputStatus} {...register("onpeak", { required: {value: true , message : "Meter on peak is required"}})} className='bg-gray-50 px-2' placeholder='kwh'/>
                        </div>
                        {errors["onpeak"] && <span className="text-red-500">{errors["onpeak"]?.message}</span>}
                        <div className='flex justify-between w-full'>
                            Off Peak
                            <input disabled={inputStatus} {...register("offpeak", { required: {value: true , message : "Meter off peak is required"}})} className='bg-gray-50 px-2' placeholder='kwh'/>
                        </div>
                        {errors["offpeak"] && <span className="text-red-500">{errors["offpeak"]?.message}</span>}
                        <div className='flex justify-between w-full'>
                            All On Peak
                            <input disabled={inputStatus} {...register("all_onpeak", { required: {value: true , message : "Meter all on peak is required"}})} className='bg-gray-50 px-2' placeholder='kwh'/>
                        </div>
                        {errors["all_onpeak"] && <span className="text-red-500">{errors["all_onpeak"]?.message}</span>}
                        <div className='flex justify-between w-full'>
                            All Off Peak
                            <input disabled={inputStatus} {...register("all_offpeak", { required: {value: true , message : "Meter all off peak is required"}})} className='bg-gray-50 px-2' placeholder='kwh'/>
                        </div>
